package com.spark.user_session.constant;
...
public interface Constants {
    ...
    //spark 相关配置参数
    String SPARK_CONF_SESSION_APPNAME = "session.appname";
    String SPARK_CONF_PAGE_APPNAME = "page.appname";
    String SPARK_CONF_Product_APPNAME = "product.appname";
    ...
    String KAFKA_METADATA_BROKER_LSIT = "metadata.broker.list";
